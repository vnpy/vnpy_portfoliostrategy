...
class LocaleBuildHook(BuildHookInterface):
    ...
    def initialize(self, version: str, build_data: dict) -> None:
        ...
        self.locale_path: Path = Path(self.root).joinpath("vnpy_portfoliostrategy", "locale")
        self.mo_path: Path = self.locale_path.joinpath("en", "LC_MESSAGES", "vnpy_portfoliostrategy.mo")
        self.po_path: Path = self.locale_path.joinpath("en", "LC_MESSAGES", "vnpy_portfoliostrategy.po")
